  ...
  try{
    ...
    const processedData = QH_data.map(qh => {
     ...
     return{
        ...
        vdt_15_avg:  qh.vdt_data.OKTE_VDT_price_wavg ?? null, // Handle cases where no match is found
        vdt_15_min: qh.vdt_data.OKTE_VDT_price_min ?? null, // Handle cases where no match is found
        vdt_15_max:  qh.vdt_data.OKTE_VDT_price_max ?? null, // Handle cases where no match is found
        vdt_15_nakup: qh.vdt_data.OKTE_VDT_nakup_obj ?? null, // Handle cases where no match is found
        vdt_15_predaj: qh.vdt_data.OKTE_VDT_predaj_obj ?? null, // Handle cases where no match is found
        DT_SK_cena: qh.dt_data.DT_SK_cena ?? null,  // Handle cases where no match is found
